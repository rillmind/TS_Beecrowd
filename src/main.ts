...
function media2() {
    ...
    const pB = 3
    const pC = 5
    let nota1 = prompt('Digite a primeira note:'); let n1 = Number(nota1)
    let nota2 = prompt('Digite a segunda nota:'); let n2 = Number(nota2)
    let nota3 = prompt('Digite a terceira nota:'); let n3 = Number(nota3)
    let media = ((n1 * pA) + (n2 * pB) + (n3 * pC)) / (pA + pB + pC)
    alert(media)
}

function diferença() {
    let valo1 = prompt('Digite o primeiro valor:'); let v1 = Number(valo1)
    let valo2 = prompt('Digite o segundo valor:'); let v2 = Number(valo2)
    let valo3 = prompt('Digite o terceiro valor:'); let v3 = Number(valo3)
    let valo4 = prompt('Digite o quarto valor:'); let v4 = Number(valo4)
